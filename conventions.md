As we’ve gone through the different components of creating a webpage, you have likely picked on some conventions for creating a webpage using HTML. However, before proceeding, let's outline them.
